...
export const PRESET_COLORS = [
  ...
  { id: 'bg-[#1a2e05] text-lime-200 border border-lime-900/50', display: 'bg-lime-800' },
  { id: 'bg-[#022c22] text-emerald-200 border border-emerald-900/50', display: 'bg-emerald-800' },
  { id: 'bg-[#083344] text-cyan-200 border border-cyan-900/50', display: 'bg-cyan-800' },
  { id: 'bg-[#0c4a6e] text-sky-200 border border-sky-900/50', display: 'bg-sky-800' },
  { id: 'bg-[#172554] text-blue-200 border border-blue-900/50', display: 'bg-blue-800' },
