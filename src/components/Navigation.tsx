  ...
  return (
    <>
      ...
      >
        ...
        <button 
          onClick={onAddClick} 
          className="w-14 h-14 bg-black/30 backdrop-blur-md border border-white/10 text-white rounded-full flex items-center justify-center shadow-2xl transition-all duration-300 hover:scale-105 active:scale-95 z-50 pointer-events-auto shrink-0"
        >
